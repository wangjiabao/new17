...
func (a *AppService) Deposit(ctx context.Context, req *v1.DepositRequest) (*v1.DepositReply, error) {
	...
	for i := 1; i <= 10; i++ {
		...
		userLength, err = getUserLength("0x6a0C83df44c2b269A27e9676b360b1Eb39CBBF30")
		if nil != err {
			fmt.Println(err)
		}
		...
		// 0x5d4bAA2A7a73dEF7685d036AAE993662B0Ef2f8F rel
		depositUsdtResult, err = getUserInfo(last, userLength-1, "0x6a0C83df44c2b269A27e9676b360b1Eb39CBBF30")
		if nil != err {
			break
		}
...
// AdminSetIspay  .
func (a *AppService) AdminSetIspay(ctx context.Context, req *v1.AdminSetIspayRequest) (*v1.AdminSetIspayReply, error) {
	return a.uuc.AdminSetIspay(ctx, req)
}
